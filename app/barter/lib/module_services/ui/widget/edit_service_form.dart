...
class EditServiceForm extends StatefulWidget {
  ...
  final Function(ServiceModel) onServiceEdit; //set
  final EditServiceRequest request;
  EditServiceForm(
      {@required this.categories, @required this.onServiceEdit, this.request});

  @override
  State<StatefulWidget> createState() => _EditServiceFormState(
        request != null ? request.serviceTitle : null,
        request != null ? request.description : null,
        request != null ? request.activeUntil : null,
      );
}
...
class _EditServiceFormState extends State<EditServiceForm> {
  ...
  _EditServiceFormState(String title, String description, String activeUntile) {
    _nameController.text = title;
    _descriptionController.text = description;
    _validUntilController.text = activeUntile;
  }
  @override
            ...
            children: [
              ...
              Padding(
                ...
                child: OutlineButton(
                  color: Theme.of(context).primaryColor,
                  onPressed: () {
                    widget.onServiceEdit(ServiceModel(
    ...
    for (int i = 0; i < 4; i++) {
      chips.add(GestureDetector(
        ...
        child: Padding(
          ...
          child: Chip(
            backgroundColor: i == _daysToFinish
